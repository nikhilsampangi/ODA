...
class Patient_DB(models.Model):
    ...
    Marital_Status = models.CharField(max_length=3, default='no')
    user = models.CharField(max_length=4 ,default='no')
...
class textinblog(models.Model):
    doctors = models.ForeignKey(Doctors, on_delete=models.PROTECT, default="")
...
class Stock_availability(models.Model):
    shop_id = models.ForeignKey(Medical_shop, on_delete=models.PROTECT, default="")
...
class Blood_avail(models.Model):
    BB_id = models.ForeignKey(Blood_Bank, on_delete=models.PROTECT, default="")
